CREATE TABLE IF NOT EXISTS `books` (
	...
	`accession_no_start` INTEGER,
	`accession_no_end` INTEGER,
	`isbn ` INTEGER UNIQUE,
	`title` VARCHAR(255),
	`author` VARCHAR(255),
	...
	`key_stage_grade_level` ENUM('KS 1 - Kinder to Grade 3', 'KS 1 & 2 - Kinder to Grade 6', 'KS 2 - Grade 4 to 6', 'KS 4 - Grade 11 to 12', 'KS 3 & 4 - Grade 7 to 12', 'KS 3 - Grade 7 to 10', 'Kinder to Grade 1', 'KS 2 & 3 - Grade 4 to 10', 'KS 1 - Kinder at Grade 3'),
	`no_of_pages` INTEGER,
	PRIMARY KEY(`book_id`)
);
